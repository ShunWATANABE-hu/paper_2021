...
ax1 = fig.add_subplot(121, title="A図：各学習アルゴリズムの成績", ylim=(0,100), xlabel="試行数", ylabel="課題成績(%)")
ax2 = fig.add_subplot(122, title="B図：学習アルゴリズム間の成績差", ylim=(-5,20), xlabel="試行数", ylabel="課題成績の差(%)") 
