...
ax1 = fig.add_subplot(121, title="A図：cohenのh(報酬3 vs 0条件)", ylim=(-0.1,0.6), xlabel="試行数", ylabel="効果量の大きさ")
ax2 = fig.add_subplot(122, title="B図：cohenのh(報酬5 vs 3条件)", ylim=(-0.1,0.6), xlabel="試行数") 
...
ax1.hlines([0.5],0,100,linestyles='dotted',color='lightslategray')
...
ax2.hlines([0.5],0,100,linestyles='dotted',color='lightslategray')
