...
ax1 = fig.add_subplot(121, title="A3.1図：Cohenのh(報酬3 vs 0条件)", ylim=(-0.1,0.5), xlabel="試行数", ylabel="効果量の大きさ")
ax2 = fig.add_subplot(122, title="A3.2図：Cohenのh(報酬5 vs 3条件)", ylim=(-0.1,0.5), xlabel="試行数") 
