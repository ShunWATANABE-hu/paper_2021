...
ax1 = fig.add_subplot(321, title="A2.1図：課題成績(MF,報酬3 vs 0条件)", ylim=(0,100), xlabel="試行数", ylabel="課題成績(%)")
ax2 = fig.add_subplot(322, title="A2.2図：課題成績(MB,報酬3 vs 0条件)", ylim=(0,100)) 
ax3 = fig.add_subplot(323, title="A2.3図：課題成績(MF,報酬5 vs 3条件)", ylim=(0,100), xlabel="試行数", ylabel="課題成績(%)")
ax4 = fig.add_subplot(324, title="A2.4図：課題成績(MB,報酬5 vs 3条件)", ylim=(0,100)) 
ax5 = fig.add_subplot(325, title="A2.5図：学習アルゴリズム間の成績差(報酬3 vs 0条件)", ylim=(-5,30), xlabel="試行数", ylabel="課題成績の差分(%)")
ax6 = fig.add_subplot(326, title="A2.6図：学習アルゴリズム間の成績差(報酬5 vs 3条件)", ylim=(-5,30)) 
