...
ax1 = fig.add_subplot(321, title="A4.1図：課題成績一覧(MB,報酬3 vs 0条件)", xlabel="β", ylabel="α")
ax2 = fig.add_subplot(322, title="A4.2図：課題成績一覧(MF,報酬3 vs 0条件)", xlabel="β", ylabel="α")
ax3 = fig.add_subplot(323, title="A4.3図：課題成績一覧(MB,報酬5 vs 3条件)", xlabel="β", ylabel="α")
ax4 = fig.add_subplot(324, title="A4.4図：課題成績一覧(MF,報酬5 vs 3条件)", xlabel="β", ylabel="α")
ax5 = fig.add_subplot(325, title="A4.5図：成績差の一覧と効果量(報酬3 vs 0条件)", xlabel="β", ylabel="α")
ax6 = fig.add_subplot(326, title="A4.6図：成績差の一覧と効果量(報酬5 vs 3条件)", xlabel="β", ylabel="α")
