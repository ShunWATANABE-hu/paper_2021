...
ax1 = fig.add_subplot(121, title="A1.1図：各学習アルゴリズムの成績", ylim=(0,100), xlabel="試行数", ylabel="課題成績(%)")
ax2 = fig.add_subplot(122, title="A1.2図：学習アルゴリズム間の成績差", ylim=(-5,20), xlabel="試行数", ylabel="課題成績の差(%)") 

ax1.plot(x, y1, label="MB_報酬3 vs 0条件")
ax1.plot(x, y2, label="MF_報酬3 vs 0条件")
ax1.plot(x, y3, label="MB_報酬5 vs 3条件")
ax1.plot(x, y4, label="MF_報酬5 vs 3条件")

ax2.plot(x, y5, label="報酬3 vs 0条件")
ax2.plot(x, y6, label="報酬5 vs 3条件")
