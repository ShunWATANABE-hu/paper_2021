...
with open('MB_optimal_data_3-0.csv') as f:
    reader = csv.reader(f)
    MB_count30 = [row for row in reader]

with open('MB_optimal_data_5-3.csv') as f:
    reader = csv.reader(f)
    MB_count53 = [row for row in reader]

with open('MF_optimal_data_3-0.csv') as f:
    reader = csv.reader(f)
    MF_count30 = [row for row in reader]

with open('MF_optimal_data_5-3.csv') as f:
    reader = csv.reader(f)
...
ax1 = fig.add_subplot(321, title="A図：逆転後10試行(報酬3 vs 0条件)", xlabel="β", ylabel="α")
ax2 = fig.add_subplot(322, title="B図：逆転後30試行(報酬3 vs 0条件)", xlabel="β", ylabel="α")
ax3 = fig.add_subplot(323, title="C図：逆転後50試行(報酬3 vs 0条件)")
ax4 = fig.add_subplot(324, title="D図：逆転後10試行(報酬5 vs 3条件)")
ax5 = fig.add_subplot(325, title="E図：逆転後30試行(報酬3 vs 0条件)")
ax6 = fig.add_subplot(326, title="F図：逆転後50試行(報酬5 vs 3条件)")
...
ax1 = fig.add_subplot(121, title="A図：逆転後10試行(報酬3 vs 0条件)", xlabel="β", ylabel="α")
ax2 = fig.add_subplot(122, title="B図：逆転後30試行(報酬3 vs 0条件)", xlabel="β", ylabel="α")
...
ax3 = fig.add_subplot(121, title="C図：逆転後50試行(報酬3 vs 0条件)")
ax4 = fig.add_subplot(122, title="D図：逆転後10試行(報酬5 vs 3条件)")
...
ax5 = fig.add_subplot(121, title="E図：逆転後30試行(報酬3 vs 0条件)")
ax6 = fig.add_subplot(122, title="F図：逆転後50試行(報酬5 vs 3条件)")
