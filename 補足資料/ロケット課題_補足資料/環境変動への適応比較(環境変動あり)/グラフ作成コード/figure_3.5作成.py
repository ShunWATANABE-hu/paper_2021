...
ax1 = fig.add_subplot(121, title="A図：各学習システムの成績(環境変動有)", ylim=(0,100), xlabel="試行数", ylabel="課題成績(%)")
ax2 = fig.add_subplot(122, title="B図：学習システム間の成績差(環境変動有)", ylim=(-10,25), xlabel="試行数", ylabel="課題成績の差分(%)") 
...
ax2.hlines([25],0,100,linestyles='dotted',color='lightslategray')

ax1.legend()
ax2.legend()

file_name = "論文_図3.5.png"
